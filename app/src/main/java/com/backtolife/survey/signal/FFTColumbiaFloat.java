...
public class FFTColumbiaFloat {
    ...
    public static Map<Integer, FFTColumbiaFloat> map = new HashMap<>();
    public static FFTColumbiaFloat build(int n){
        if(!FFTColumbiaFloat.map.containsKey(n)){
            FFTColumbiaFloat.map.put(n, new FFTColumbiaFloat(n));
        }
        return FFTColumbiaFloat.map.get(n);
    }

    public FFTColumbiaFloat(int n) {
        this.n = n;
    ...
    public static void main(String[] args) {
        ...
        FFTColumbiaFloat fft = new FFTColumbiaFloat(N);
    ...
    protected static void beforeAfter(FFTColumbiaFloat fft, float[] re, float[] im) {
